...
def recommend(user,test_data,communities,network,kcs):
...
if __name__ == '__main__':
	...
	for alg_type in alg_types:
		...
		with Pool(5) as p:
			results = p.starmap(recommend,zip(most_active_users,repeat(test_data),repeat(communities),repeat(network),repeat(concepts)))
